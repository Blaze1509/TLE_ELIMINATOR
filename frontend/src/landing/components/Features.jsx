...
const Feature = () => {
  const services = [
    {
      ...
      description:
        "Blockchain-backed registry ensuring transparency, traceability, and trust in carbon credit records.",
      mediaSrc: "/Feature2.mp4",
      mediaType: "video",
    },
    {
      title: "AI-Powered Verification",
      description:
        "Utilizing satellite imagery and AI to monitor and verify the progress of carbon sequestration projects.",
      mediaSrc:
        "https://images.unsplash.com/photo-1677756119517-756a188d2d94?auto=format&fit=crop&w=800&q=60",
      mediaType: "image",
    },
    {
      title: "Community & NGO Onboarding",
      description:
        "Inclusive platform for NGOs, coastal communities, and panchayats to actively participate in carbon restoration.",
      mediaSrc:
    ...
    },
    {
      ...
      description:
        "Smart contracts enable seamless carbon credit issuance, trading, and monetization for verified projects.",
      mediaSrc: "/Feature3.mp4",
      mediaType: "video",
    },
  ];
  ...
  return (
    <div
      ref={componentRef}
      className="bg-white w-full py-32 px-6 sm:px-12 md:px-20 overflow-x-hidden"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24 feature-header">
          ...
          <p className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto">
            A suite of powerful tools designed for transparency, community
